...
% ----------------------------------------------------------------
% HGR Function - ProjectHGR
% by Caglar Arslan and Okan Cilingiroglu
% This function recognizes the given hand gesture image and outputs the 
...
% ----------------------------------------------------------------
% THE ALGORITHM
% For details of the overall mechanism of the algorithm, open the
...
% ----------------------------------------------------------------
% ----------------------------------------------------------------
% END - I hope you liked it. Best wishes. //Caglar Arslan
% ----------------------------------------------------------------
